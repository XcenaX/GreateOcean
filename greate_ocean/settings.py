"""
Django settings for greate_ocean project.
...
SECRET_KEY = 'z#hzye7c-ac#8vtxnc1q4kp0h5(^q7b8+3a(aovg7wg91sn(^u'
...
ROOT_URLCONF = 'greate_ocean.urls'
...
WSGI_APPLICATION = 'greate_ocean.wsgi.application'
